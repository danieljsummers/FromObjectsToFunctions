...
To start, bring the `Entities.fs` file over from Tres. Then, some code will help all this DU stuff make sense.  One of
the forms of a DU is called a single-case discriminated union; it can be used to wrap primitives to make them more
meaningful. We'll create the following single-case DUs at the top of the file, before our other types:
*)
...
You can
[review the entire set of types](https://github.com/danieljsummers/FromObjectsToFunctions/tree/v2-step-2/src/4-Freya-FSharp/Entities.fs)
